...
import br.com.fiap.byte_bank_api.model.Pix;
import br.com.fiap.byte_bank_api.model.Pix;
import br.com.fiap.byte_bank_api.model.Deposito;
import br.com.fiap.byte_bank_api.model.Conta;
...
public class ContaController {
    ...
    public ResponseEntity<Conta> depositar(@RequestBody Deposito dadosDeposito) {
    ...
    public ResponseEntity<Conta> sacar(@RequestBody Deposito dadosSaque) {
    ...
    public ResponseEntity<Conta> transferirPix(@RequestBody Pix dadosPix) {
